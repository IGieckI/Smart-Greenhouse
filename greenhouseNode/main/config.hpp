...
// #define SOIL_MOISTURE_WET_VAL     960 ///// SEE_PERSONAL_CONFIG
...
// #define DS18B20_DATA_PIN    GPIO_NUM_32 ///// SEE_PERSONAL_CONFIG
...
// #define NODE_ID 9 ///// SEE_PERSONAL_CONFIG
#define XSTR(x) STR(x)
#define STR(x) #x
